...
class AdvertisementType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('town', CollectionType::class, array('entry_type' => TownType::class, 'allow_add' => true, 'allow_delete' => true))
            ...
            ->add('category', EntityType::class, array('class' => 'DadaAdvertisementBundle:Category', 'choice_label' => 'name', 'multiple' => true, 'label' => 'Catégorie'))
